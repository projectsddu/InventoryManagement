...
&nbsp; </b>
            ...
            <div class="mb-3">
                <label for="TextboxQuantity" class="form-label"><b>Quantity: 
...
&nbsp;&nbsp; </b></label>
            ...
            <div class="mb-3">
                <label for="TextBoxBuyingPrice" class="form-label"><b>Buying Price:
...
&nbsp;</b><asp:RequiredFieldValidator ID="buyingPriceValidator" runat="server" ControlToValidate="TextBoxBuyingPrice" ErrorMessage=" *Buying Price is required" ForeColor="Red" style="font-weight: 700"></asp:RequiredFieldValidator>
            ...
            <div class="mb-3">
                <label for="TextBoxBuyingPrice" class="form-label"><b>Selling Price: 
